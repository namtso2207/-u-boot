...
static char kbi_help_text[] =
		...
		"\n"
		"kbi forcereset [gpio] w <0|1> - disable/enable force-reset\n"
		"kbi forcereset [gpio] r - read state of force-reset\n"
		"[notice: the gpio boot trigger must be enabled if you want to enable force-reset]\n"
		"\n"
		"kbi bootmode w <emmc|spi> - set bootmode to emmc or spi\n"
		"kbi bootmode r - read current bootmode\n"
		"\n"
		"kbi trigger [rtc|dcin|key|gpio] w <0|1> - disable/enable boot trigger\n"
		"kbi trigger [rtc|dcin|key|gpio] r - read mode of a boot trigger";
